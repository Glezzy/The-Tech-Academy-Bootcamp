...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //Active play may only be 'X' or 'O' sp, if not 'X' it must be 'O'.
        } else {
            //If activePlayer is equal to 'O', the o.png is place in HTML.
            select.style.backgroundImage = 'url("o.png")';
        }

        //squareNumber and activePlayer are concatenated together and added to
        //the array.
        ...
        audio('beep.mp3');
        //This condition checks to see if it ius computers turn.
        if(activePlayer === 'O') {
    ...
    function computersTurn() {
        ...
        let pickASquare;
        //This condition allows our while loop to keep trying if a square is
        //selected yet.
        while(!success) {
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        function animateLineDrawing() {
            ...
            //This condition is similar to the one above. It was necessary for the
            //6, 4, 2 win condition.
            if (x1 <= x2 && y1 >= y2) {
                if (x < x2) { x += 10; }
                if (y > y2) { y -= 10; }
